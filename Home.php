...
<header>
    <div class="container text-right"><a>ようこそ<u><?php echo htmlspecialchars($_SESSION["NAME"], ENT_QUOTES); ?></u>さん</a></div>
    <div class="container text-center">
        <div class="fh5co-navbar-brand">
            <div class="fh5co-login">
                <div class="loginbtn"><a href="/mypage.php" class="btn hanten free_submit">マイページ</a></div>
                <div class="loginbtn"><a href="logout.php" class="btn">ログアウト</a></div>  
            </div>
            <a class="fh5co-logo" href="Home.php">Funsehold</a>
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0 text-center fh5co-table">
                <div class="fh5co-intro fh5co-table-cell">
                    <h1 class="text-center">Go for it!</h1>
                    <p>レシピも日記も家計簿も一つにまとめちゃおう♪</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="col-md-6 col-sm-6 services-num">
                    ...
                    <div class="desc">
                        <h3>家事の時短・効率化</h3>
                        <p>レシピ検索、家計簿と個々のアプリはあるけれど、１つにまとまっていたら便利だなという思いからスタート。更に面倒くさがりな私のあったらいいな機能をつけた。</p>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6 services-num">
                    ...
                    <div class="desc">
                        <h3>家事の見える化</h3>
                        <p>当たり前の家事も記録を残したら、新たな発見があって楽しいかも。家事の見える化によって、毎日の家事を楽しみたい。</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="fh5co-services">
                    ...
                    <div class="holder-section">
                        <h3>献立レシピ</h3>
                        <p>毎日の献立に悩む時間がムダだと思いませんか。家にある食材や特売品で献立表を作ろう。また、食材使い切る献立を考え、食品ロスも減らしましょう。 </p>
                    </div>
                </div>
                <div class="fh5co-services">
                    ...
                    <div class="holder-section">
                        <h3>在庫管理</h3>
                        <p>家にある食材や日用品を登録して、家の在庫を管理しよう。</p>
                    </div>
                </div>
                <div class="fh5co-services">
                    ...
                    <div class="holder-section">
                        <h3>買い物</h3>
                        <p>献立を基に買い出しリスト作成、その他の買う物を登録して、効率的に買い物しよう。 </p>
                    </div>
                </div>
                <div class="fh5co-services">
